 ...
 * @package oceanic
 */
define( 'OCEANIC_THEME_VERSION' , '1.0.10' );
...
function oceanic_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Quick Menu area', 'oceanic' ),
		'id'            => 'quick-menu',
		'description'   => '',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
...
function oceanic_theme_scripts() {
    ...
    wp_enqueue_style( 'oceanic-custom-style', get_template_directory_uri().'/templates/css/custom.css', array(), OCEANIC_THEME_VERSION );
